...
def main():
    ...
    path_for_cat_folder = r'C:\Users\user1\Desktop\School\Git\cat_dogs-grayscale-dataset\train_set\cats\*.jpg'
    path_for_dog_folder = r'C:\Users\user1\Desktop\School\Git\cat_dogs-grayscale-dataset\train_set\dogs\*.jpg'
    path_to_save_model = r"C:\Users\user1\Desktop\School\Git\model.ckpt"
    ...
    # Hidden layers size#
    hidden_layer_node1 = 300
    hidden_layer_node2 = 15
    ...
    # Hidden layer 1#
    W1 = tf.Variable(tf.random.truncated_normal([features, hidden_layer_node1], stddev=0.1), name="Ws1")
    ...
    # Hidden layer
    W2 = tf.Variable(tf.random.truncated_normal([hidden_layer_node1, hidden_layer_node2], stddev=0.1), name="Ws2")
    ...
    W = tf.Variable(tf.fill([hidden_layer_node2, 1], eps), name="Ws")
